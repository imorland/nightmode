...
const transPrefix = `giffgaffcommunity-nightmode.admin.settings.modal`;
...
export default () => {
    app.extensionSettings['giffgaffcommunity-nightmode'] = () =>
        app.modal.show(
            new SettingsModal({
                title: app.translator.trans(`${transPrefix}.title`),
                size: 'small',
                className: 'giffgaffcommunity-nightmode',
                items: [
                    <div className="Form-group">
                        ...
                        {SelectItem.component({
                            ...
                            key: 'giffgaffcommunity-nightmode.default_theme',
                            required: false,
                            cast: (inVar) => {
